...
export default function Home() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#FAF8F5] text-[#1E1E1E]">
      {/* Animated geometric network background explicitly locked to back layer */}
      <GeometricBackground />

      {/* Ambient radial glow */}
      <div className="pointer-events-none absolute left-0 top-0 z-0 h-full w-full bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))] from-white/40 via-transparent to-transparent" />

      {/* Foreground content structured with proper z-index layer stack */}
      <div className="relative z-10">
        ...
        <footer className="border-t border-[#E6DFD3]/60 py-6 text-center text-xs text-[#6B6560]">
